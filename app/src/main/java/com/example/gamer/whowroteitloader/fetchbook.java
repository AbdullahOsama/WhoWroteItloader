...
public class fetchbook extends AsyncTask<String,Void,String>{
    ...
    public fetchbook(Context cntxt, TextView titleText, TextView authorText, EditText bookInput, RecyclerView recyclerView) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            final String DOWNLOADABLE = "download"; // Parameter to filter by print type.
        ...
        try {
            ...
            while (i < itemsArray.length() || (authors == null && title == null)) {
                ...
                if ((title != null) && (authors != null)) {
                    myArray.add(new myBook(title, authors));
                }
            ...
            if (myArray.size() > 0) {
                ad = new MyAdapterClass(cntxt,myArray);

                myRecyclerView.setAdapter(ad);
                myRecyclerView.setLayoutManager(new LinearLayoutManager(cntxt));
                mBookInput.setText("");
            } else {
